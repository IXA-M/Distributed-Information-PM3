...
app.get("/docs", createDocsHandler({ openApiPath: "./openapi.yaml", title: "User Profile Service API Docs" }));
app.get("/api-docs", createDocsHandler({ openApiPath: "./openapi.yaml", title: "User Profile Service API Docs" }));
